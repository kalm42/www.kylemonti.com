...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Button**         | `variant` (primary fill / secondary outline / quiet underline text), `size` (sm 40px / md 48px / lg 56px / inherit), `arrow`, `icon`, `href`, `external` | One primary per view. Verb-first, sentence case. `on-brand` text on primary. `variant="quiet"` is also the inline link within body text — evergreen rule draws on hover; pair with `size="inherit" padding="none"` so it takes the surrounding text's size instead of a UI size. |
